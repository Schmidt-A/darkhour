...
void AddFlamingEffectToWeapon(object oTarget, float fDuration, int nCasterLevel)
{
   ...
   if (nCasterLevel >= 25) nBonus = IP_CONST_DAMAGEBONUS_1d10;
   else if (nCasterLevel >= 20 ) nBonus = IP_CONST_DAMAGEBONUS_1d8;
   else if (nCasterLevel >= 15 ) nBonus = IP_CONST_DAMAGEBONUS_1d6;
   else if (nCasterLevel >= 10 ) nBonus = IP_CONST_DAMAGEBONUS_1d4;
