...
void main()
{
    ...
    FloatingTextStringOnCreature("*With blinding speed you run right straight into a wall*", oPC, FALSE);
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectSlow(), oPC, 18.0);
//pwned By Jantima as requested by Vladiat0r
/*
