...
StoreCampaignObject("NPC_STORAGE","21",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","21",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 21 Successfully");
}
