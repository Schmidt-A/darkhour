...
// End of Spell Cast Hook
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        //Make SR Check
        ///Antiworld change = if the target has spellmantle do only one check  (only one arrow)
        if (GetHasSpellEffect(SPELL_SPELL_MANTLE,oTarget) ||  GetHasSpellEffect(SPELL_GREATER_SPELL_MANTLE,oTarget)||  GetHasSpellEffect(SPELL_LESSER_SPELL_MANTLE,oTarget))
        {
        ...
        else  //do a check for every flame arrow
        {
