...
if(GetItemPossessedBy(oPC, "set_cha_gloves") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_cha_gloves"));
if(iOrbs > 1)
    {
    int iStack = iOrbs - 1;
...
object oCreate = CreateItemOnObject("set_cha_gloves001", oPC);
