...
effect CreateGoodTideEffectsLinkAW();
effect CreateGoodTideEffectsLinkAW()
{
    ...
    effect  eLink = EffectLinkEffects(eDamage, eSaves);
...
void main()
{
    ...
    effect eLink2 = CreateGoodTideEffectsLinkAW();
    ...
    if (DoApplyEffects(oCreator,oTarget))
    {
        ...
        else if(oTarget == oCreator)
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_PERMANENT,  EffectAttackIncrease(2), oTarget);
        }
    }
}
