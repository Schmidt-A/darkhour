...
if (nRound >= 999)
{
    ...
    ApplyEffectToObject(DURATION_TYPE_INSTANT, eFNF, oTarget);
    ApplyEffectToObject(DURATION_TYPE_INSTANT, eVis,oTarget);
    DelayCommand(0.01, ApplyEffectToObject(DURATION_TYPE_INSTANT, eDam,oTarget));
    int nChance = d100(1);
    if ((nChance > 75) && (GetLocalInt(oTarget, "HuntKD") != TRUE) )
    {
        effect eKD = EffectKnockdown();
        DelayCommand(0.01, ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eKD ,oTarget, RoundsToSeconds(2)));
