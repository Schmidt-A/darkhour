...
// End - Spell Cast Hook -------------------------------------------
    ...
    //Fixing the bug where you get 127 DC if you have negative Con.
    int nConMod = GetAbilityModifier(ABILITY_CONSTITUTION, OBJECT_SELF);
    int nDC = 10 + nConMod + nCasterLevel/2;
