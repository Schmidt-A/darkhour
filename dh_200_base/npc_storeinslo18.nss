...
StoreCampaignObject("NPC_STORAGE","18",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","18",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 18 Successfully");
}
