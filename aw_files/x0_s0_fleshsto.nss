...
// End of Spell Cast Hook
    ...
    /// Ctf - antiworld ///
                ...
                {
                ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectPetrify(), oTarget, RoundsToSeconds(nDuration));
                }
    ///End of ctf addition

       ///original:// DoPetrification(nCasterLvl, OBJECT_SELF, oTarget, GetSpellId(), GetSpellSaveDC());
       }
}
