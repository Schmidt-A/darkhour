...
StoreCampaignObject("NPC_STORAGE","23",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","23",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 23 Successfully");
}
