...
StoreCampaignObject("NPC_STORAGE","27",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","27",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 27 Successfully");
}
