...
if(iLevel == 1)
    {
    CreateObject(OBJECT_TYPE_CREATURE, "lessercovebandit", lLoc, TRUE);
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "lessercovebandit", lLoc, TRUE);
    CreateObject(OBJECT_TYPE_CREATURE, "lessercovebandit", lLocTwo, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "greatcovebandit", lLoc, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "greatcovebandit", lLoc, TRUE);
    CreateObject(OBJECT_TYPE_CREATURE, "greatcovebandit", lLocTwo, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
