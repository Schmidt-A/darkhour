...
StoreCampaignObject("NPC_STORAGE","28",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","28",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 28 Successfully");
}
