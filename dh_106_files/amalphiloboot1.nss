...
if(GetItemPossessedBy(oPC, "set_wis_boots") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_wis_boots"));
if(iOrbs > 1)
    {
    int iStack = iOrbs - 1;
...
object oCreate = CreateItemOnObject("set_wis_boots001", oPC);
