...
// End of Spell Cast Hook
    ...
    {
        nDuration = 3;
        if (GetLocalInt(OBJECT_SELF, "Ant") != TRUE)
        {
            FloatingTextStringOnCreature("You may summon a swarm again in 18 seconds.", OBJECT_SELF);
            SetLocalInt(OBJECT_SELF, "Ant", TRUE);
            DelayCommand(RoundsToSeconds(3), DeleteLocalInt(OBJECT_SELF, "Ant"));
