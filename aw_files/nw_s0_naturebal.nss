...
//:: Modified By: riddler
//:: Changed so also does spell breach
...
// End of Spell Cast Hook
    ...
    object oTarget = GetFirstObjectInShape(SHAPE_SPHERE, RADIUS_SIZE_HUGE, GetLocation(OBJECT_SELF), FALSE);
    ...
    while(GetIsObjectValid(oTarget))
    {
        ...
        if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
        {
            ...
            if(!GetIsReactionTypeFriendly(oTarget))
            {
               ...
               // {
                      ...
                      DelayCommand(fDelay, DoSpellBreach(oTarget,4,nRand,GetSpellId()));
        ...
        oTarget = GetNextObjectInShape(SHAPE_SPHERE, RADIUS_SIZE_HUGE, GetLocation(OBJECT_SELF), FALSE);
    }
}
