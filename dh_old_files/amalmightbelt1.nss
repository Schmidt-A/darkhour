...
if(GetItemPossessedBy(oPC, "set_str_belt") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_str_belt"));
if(iOrbs > 1)
    {
    int iStack = iOrbs - 1;
...
object oCreate = CreateItemOnObject("set_str_belt001", oPC);
