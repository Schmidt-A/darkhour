...
StoreCampaignObject("NPC_STORAGE","6",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","6",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 6 Successfully");
}
