...
StoreCampaignObject("NPC_STORAGE","7",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","7",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 7 Successfully");
}
