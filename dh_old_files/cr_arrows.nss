...
if(iRand < 100)
    {
    CreateItemOnObject("mw_arrows", oPC, iRand);
    }else
        {
        CreateItemOnObject("mw_arrows", oPC, 99);
        CreateItemOnObject("mw_arrows", oPC, iRand - 99);
        }
...
if(iRand < 100)
    {
    CreateItemOnObject("cr_arrows", oPC, iRand);
    }else
        {
        CreateItemOnObject("cr_arrows", oPC, 99);
        CreateItemOnObject("cr_arrows", oPC, iRand - 99);
        }
SendMessageToPC(oPC, "You have created " + IntToString(iRand) + " ammunition.");
return;
}
