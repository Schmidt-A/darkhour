...
if(iRand < 51)
    {
    CreateItemOnObject("mw_darts", oPC, iRand);
    }else
        {
        CreateItemOnObject("mw_darts", oPC, 50);
        CreateItemOnObject("mw_darts", oPC, iRand - 50);
        }
...
if(iRand < 51)
    {
    CreateItemOnObject("cr_darts", oPC, iRand);
    }else
        {
        CreateItemOnObject("cr_darts", oPC, 50);
        CreateItemOnObject("cr_darts", oPC, iRand - 50);
        }
SendMessageToPC(oPC, "You have created " + IntToString(iRand) + " ammunition.");
return;
}
