...
// state. 
string sAssociateMasterConditionVarname = "NW_ASSOCIATE_MASTER";
...
int NW_ASC_IS_BUSY =             0x40000000; 

//Not actually used, here for system continuity
int NW_ASC_HAVE_MASTER =         0x80000000; 
