...
if(iLevel == 1)
    {
    CreateObject(OBJECT_TYPE_CREATURE, "lesseracolyte", lLoc, TRUE);
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "lesseracolyte", lLoc, TRUE);
    CreateObject(OBJECT_TYPE_CREATURE, "lesseracolyte", lLocTwo, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "greatfogspiri001", lLoc, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "greatfogspiri001", lLoc, TRUE);
    CreateObject(OBJECT_TYPE_CREATURE, "greatfogspiri001", lLocTwo, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
