...
if(GetItemPossessedBy(oPC, "set_cha_ring001") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_cha_ring001"));
if(iOrbs > 2)
    {
    int iStack = iOrbs - 2;
...
object oCreate = CreateItemOnObject("set_cha_ring002", oPC);
