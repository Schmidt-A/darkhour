...
StoreCampaignObject("NPC_STORAGE","26",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","26",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 26 Successfully");
}
