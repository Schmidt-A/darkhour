...
StoreCampaignObject("NPC_STORAGE","12",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","12",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 12 Successfully");
}
