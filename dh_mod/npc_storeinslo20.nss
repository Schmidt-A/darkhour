...
StoreCampaignObject("NPC_STORAGE","20",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","20",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 20 Successfully");
}
