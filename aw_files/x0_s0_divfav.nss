...
// End of Spell Cast Hook
   ...
   //Antiworld change not to stack Attack bonus for clerics Divine Favor Divine Power   Battletide
    ...
    // eAttack has been detached to be removed without remove the other
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eAttack, oTarget, TurnsToSeconds(nDuration));
