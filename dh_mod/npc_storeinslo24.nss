...
StoreCampaignObject("NPC_STORAGE","24",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","24",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 24 Successfully");
}
