...
StoreCampaignObject("NPC_STORAGE","2",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","2",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 2 Successfully");
}
