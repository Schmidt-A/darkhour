...
if(iRand < 51)
    {
    CreateItemOnObject("mw_shuriken", oPC, iRand);
    }else
        {
        CreateItemOnObject("mw_shuriken", oPC, 50);
        CreateItemOnObject("mw_shuriken", oPC, iRand - 50);
        }
...
if(iRand < 51)
    {
    CreateItemOnObject("cr_shuriken", oPC, iRand);
    }else
        {
        CreateItemOnObject("cr_shuriken", oPC, 50);
        CreateItemOnObject("cr_shuriken", oPC, iRand - 50);
        }
SendMessageToPC(oPC, "You have created " + IntToString(iRand) + " ammunition.");
return;
}
