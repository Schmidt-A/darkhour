...
void StoreInventoryInfo(object oPC)
{
    int iZombieKills = 0;
    int iSurvivalTime = 0;
...
void main()
{
    ...
    TriggerRest(oPC);
    StoreInventoryInfo(oPC);
    
/* 
    This may not be necessary because the rest convo covers this case.
    also we werent doing anything different
