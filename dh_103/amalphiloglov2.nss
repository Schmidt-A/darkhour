...
if(GetItemPossessedBy(oPC, "set_wis_glove001") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_wis_glove001"));
if(iOrbs > 2)
    {
    int iStack = iOrbs - 2;
...
object oCreate = CreateItemOnObject("set_wis_glove002", oPC);
