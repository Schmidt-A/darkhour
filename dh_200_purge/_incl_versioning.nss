...
void TokensToVars(object oPC, object oPCToken)
{
    ...
    SendMessageToPC(oPC, "Kill = " + IntToString(iZombieKillTokens));
    SendMessageToPC(oPC, "Survive = " + IntToString(iSurvivalTokens));
    SendMessageToPC(oPC, "Frenzy = " + IntToString(iFrenzyKillTokens));
