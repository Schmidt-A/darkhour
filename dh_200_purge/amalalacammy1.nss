...
if(GetItemPossessedBy(oPC, "set_dex_ammy") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_dex_ammy"));
if(iOrbs > 1)
    {
    int iStack = iOrbs - 1;
...
object oCreate = CreateItemOnObject("set_dex_ammy001", oPC);
