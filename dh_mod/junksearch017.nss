...
void main()
{
    ...
    if (nFound < 10)
    {
       sWhat = "nw_it_mpotion009";
    }
    else if (nFound < 20)
    {
       sWhat = "nw_it_mpotion015";
    }
    else if (nFound < 30)
    {
       sWhat = "nw_it_mpotion014";
    }
    else if (nFound < 35)
    {
       sWhat = "nw_it_mpotion013";
    }
    else if (nFound < 40)
    {
       sWhat = "nw_it_mpotion016";
    }
    else if (nFound < 45)
    {
    ...
    {
       sWhat = "nw_it_mpotion004";
    }
    else if (nFound < 47)
    {
       sWhat = "nw_it_mpotion005";
    }
    else
    {
       if (Random(3) == 1)
