...
void DoDamage(object oPC, int iDamage)
{
    ...
    if(GetIsObjectValid(oHench1))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oHench1);
        }
    }
    if(GetIsObjectValid(oHench2))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oHench2);
        }
    }
    if(GetIsObjectValid(oHench3))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oHench3);
        }
    }
    if(GetIsObjectValid(oSummoned))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oSummoned);
        }
    }
    if(GetIsObjectValid(oDominated))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oDominated);
        }
    }
    if(GetIsObjectValid(oAnimal))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oAnimal);
        }
    }
    if(GetIsObjectValid(oFamiliar))
    {
        ...
        if(GetTag(oTorch) != "hx_berry_torch")
        {
            ...
            ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ACID_S), oFamiliar);
        }
    }
}
