...
if(GetItemPossessedBy(oPC, "set_wis_ammy001") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_wis_ammy001"));
if(iOrbs > 2)
    {
    int iStack = iOrbs - 2;
...
object oCreate = CreateItemOnObject("set_wis_ammy002", oPC);
