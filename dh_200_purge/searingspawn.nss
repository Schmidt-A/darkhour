...
if(iLevel == 1)
    {
    CreateObject(OBJECT_TYPE_CREATURE, "lessersearing", lLoc, TRUE);
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "lessersearing", lLoc, TRUE);
    CreateObject(OBJECT_TYPE_CREATURE, "lessersearing", lLocTwo, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "greatsearing", lLoc, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
    ...
    {
    CreateObject(OBJECT_TYPE_CREATURE, "greatsearing", lLoc, TRUE);
    CreateObject(OBJECT_TYPE_CREATURE, "greatsearing", lLocTwo, TRUE);
    SetLocalInt(OBJECT_SELF, "canspawn", 1);
    DelayCommand(300.0, SetLocalInt(OBJECT_SELF, "canspawn", 0));
    return;
    }
