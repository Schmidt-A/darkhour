...
StoreCampaignObject("NPC_STORAGE","8",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","8",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 8 Successfully");
}
