...
// End of Spell Cast Hook
    ...
    effect eSave2 = VersusAlignmentEffect(eSave,ALIGNMENT_ALL, ALIGNMENT_NEUTRAL);
    effect eImmune = EffectImmunity(IMMUNITY_TYPE_MIND_SPELLS);
    eImmune = VersusAlignmentEffect(eImmune,ALIGNMENT_ALL, nAlign);
    effect eImmune2 = VersusAlignmentEffect(eImmune,ALIGNMENT_ALL, ALIGNMENT_NEUTRAL);
