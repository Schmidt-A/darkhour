...
if(GetItemPossessedBy(oPC, "set_str_gloves001") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_str_gloves001"));
if(iOrbs > 2)
    {
    int iStack = iOrbs - 2;
...
object oCreate = CreateItemOnObject("set_str_gloves002", oPC);
