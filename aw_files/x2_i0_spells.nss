    ...
    if (GetHasFeat(988, OBJECT_SELF))
    {
        ...
        if (GetIsObjectValid(oWeapon))
        {
           ...
           IPSafeAddItemProperty(oWeapon, ItemPropertyOnHitProps(IP_CONST_ONHIT_DEAFNESS,IP_CONST_ONHIT_SAVEDC_20,IP_CONST_ONHIT_DURATION_25_PERCENT_3_ROUNDS), RoundsToSeconds(nRounds), X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE,TRUE);
            ...
            //dragon bonuses, riddler 2007-4-25
           IPSafeAddItemProperty(oWeapon, ItemPropertyDamageBonusVsRace(IP_CONST_RACIALTYPE_DRAGON, IP_CONST_DAMAGETYPE_MAGICAL,IP_CONST_DAMAGEBONUS_2d6),RoundsToSeconds(nRounds),X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE,TRUE);
           IPSafeAddItemProperty(oWeapon, ItemPropertyEnhancementBonusVsRace(IP_CONST_RACIALTYPE_DRAGON,7),RoundsToSeconds(nRounds),X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE,TRUE);
        }
