...
StoreCampaignObject("NPC_STORAGE","17",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","17",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 17 Successfully");
}
