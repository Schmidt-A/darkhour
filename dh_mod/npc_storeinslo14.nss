...
StoreCampaignObject("NPC_STORAGE","14",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","14",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 14 Successfully");
}
