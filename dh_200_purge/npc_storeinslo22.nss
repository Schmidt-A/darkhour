...
StoreCampaignObject("NPC_STORAGE","22",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","22",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 22 Successfully");
}
