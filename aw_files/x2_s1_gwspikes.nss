...
void HuntManticoreAttack(int nMissiles, int nCap, int nSpell, int nMIRV = VFX_IMP_MIRV,
    int nVIS = VFX_IMP_MAGBLUE, int nDAMAGETYPE = DAMAGE_TYPE_MAGICAL, int nONEHIT = FALSE);
void HuntManticoreAttack(int nMissiles, int nCap, int nSpell, int nMIRV = VFX_IMP_MIRV,
    int nVIS = VFX_IMP_MAGBLUE, int nDAMAGETYPE = DAMAGE_TYPE_MAGICAL, int nONEHIT = FALSE)
{
...
void main()
{
    ...
    if (nRound >= 999)
    {
        HuntManticoreAttack(10, 10, GetSpellId(), 359, VFX_COM_BLOOD_SPARK_SMALL, DAMAGE_TYPE_BLUDGEONING);
    }
    else
    {
