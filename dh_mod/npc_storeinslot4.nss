...
StoreCampaignObject("NPC_STORAGE","4",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","4",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 4 Successfully");
}
