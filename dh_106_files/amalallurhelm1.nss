...
if(GetItemPossessedBy(oPC, "set_cha_helm") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_cha_helm"));
if(iOrbs > 1)
    {
    int iStack = iOrbs - 1;
...
object oCreate = CreateItemOnObject("set_cha_helm001", oPC);
