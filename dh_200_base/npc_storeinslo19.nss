...
StoreCampaignObject("NPC_STORAGE","19",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","19",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 19 Successfully");
}
