...
// End of Spell Cast Hook
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        if(!MyResistSpell(OBJECT_SELF, oTarget))
        {
            ...
            {
                SendMessageToPC(oTarget, "<cýý>" + GetName(oTarget) + "</c><c.ÍÙ> : AC check : *failed* : " + sCheck + "</c>");
                SendMessageToPC(OBJECT_SELF, "<cýý>" + GetName(oTarget) + "</c><c.ÍÙ> : AC check : *failed* : " + sCheck + "</c>");
