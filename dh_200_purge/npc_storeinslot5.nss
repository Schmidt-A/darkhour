...
StoreCampaignObject("NPC_STORAGE","5",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","5",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 5 Successfully");
}
