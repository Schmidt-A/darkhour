...
StoreCampaignObject("NPC_STORAGE","25",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","25",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 25 Successfully");
}
