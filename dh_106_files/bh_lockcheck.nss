...
//      if ((GetTag(oItem) == "Food") || (GetTag(oItem) == "Spoiled"))
    ...
    {
        SetLocked(GetObjectByTag("BH_LD1"),FALSE);
        SetLocked(GetObjectByTag("BH_LD2"),FALSE);
        SetLocked(GetObjectByTag("BH_LD3"),FALSE);
        SetLocked(GetObjectByTag("BH_LD4"),FALSE);
        SetLocked(GetObjectByTag("BH_LD5"),FALSE);
        SetLocked(GetObjectByTag("BH_LD6"),FALSE);
        SetLocked(GetObjectByTag("BH_LD7"),FALSE);
    }
}
