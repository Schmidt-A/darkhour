...
object GetTargetedOrEquippedMeleeWeapon(object oTarget)
{
...
{
return GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oTarget);
}
else
{
...
void main()
{
    ...
    */
    ...
    if(nCasterLvl > 5)
    {
     ...
     object oMyWeapon   =  GetTargetedOrEquippedMeleeWeapon(oTarget);
