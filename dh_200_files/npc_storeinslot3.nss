...
StoreCampaignObject("NPC_STORAGE","3",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","3",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 3 Successfully");
}
