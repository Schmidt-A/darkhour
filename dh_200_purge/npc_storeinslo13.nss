...
StoreCampaignObject("NPC_STORAGE","13",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","13",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 13 Successfully");
}
