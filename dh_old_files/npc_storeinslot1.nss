...
StoreCampaignObject("NPC_STORAGE","1",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","1",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 1 Successfully");
}
