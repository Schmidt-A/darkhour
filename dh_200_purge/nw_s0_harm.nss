...
// End of Spell Cast Hook
    ...
    {
    AssignCommand(OBJECT_SELF,SpeakString("Rise my Minions! RISE!"));
    int nSpawnCreatures = GetLocalInt(OBJECT_SELF,"Rise");
    string sRise = IntToString(nSpawnCreatures);
    object oCreature;
        oCreature = GetNearestObjectByTag("dh_leaper"+sRise);
        ...
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_PARALYZED))),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectHaste())),oCreature);
        oCreature = GetNearestObjectByTag("dh_reaper"+sRise);
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectResurrection(),oCreature);
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectHeal(GetMaxHitPoints(oCreature)),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_PARALYZED))),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectHaste())),oCreature);
        oCreature = GetNearestObjectByTag("dh_revenant"+sRise);
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectResurrection(),oCreature);
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectHeal(GetMaxHitPoints(oCreature)),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_PARALYZED))),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectHaste())),oCreature);
        oCreature = GetNearestObjectByTag("ZN_ZOMBIEB"+sRise);
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectResurrection(),oCreature);
        ApplyEffectToObject(DURATION_TYPE_INSTANT,EffectHeal(GetMaxHitPoints(oCreature)),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectVisualEffect(VFX_DUR_PARALYZED))),oCreature);
        ApplyEffectToObject(DURATION_TYPE_PERMANENT,SupernaturalEffect(ExtraordinaryEffect(EffectHaste())),oCreature);
        SetLocalInt(OBJECT_SELF,"Rise",nSpawnCreatures+1);
    }
