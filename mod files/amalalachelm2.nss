...
if(GetItemPossessedBy(oPC, "set_dex_helm001") == OBJECT_INVALID)
    {
...
DestroyObject(GetItemPossessedBy(oPC, "set_dex_helm001"));
if(iOrbs > 2)
    {
    int iStack = iOrbs - 2;
...
object oCreate = CreateItemOnObject("set_dex_helm002", oPC);
