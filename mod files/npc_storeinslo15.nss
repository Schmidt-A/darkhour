...
StoreCampaignObject("NPC_STORAGE","15",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","15",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 15 Successfully");
}
