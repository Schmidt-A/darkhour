...
StoreCampaignObject("NPC_STORAGE","9",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","9",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 9 Successfully");
}
