...
void main()
{
    ...
    {
    //Thieves Tools +3
        sWhat = "nw_it_picks002";
    }
    else if (nFound < 15)
    {    //1d2 con damage venom (Mild)
        sWhat = "x2_it_poison015";
    }
    else if (nFound < 25)
    {    //1d2 con damage venom (weak)
        sWhat = "x2_it_poison009";

    }
    else if (nFound < 35)
    {     //1d2 str damage venom (Average)
        sWhat = "x2_it_poison020";
    }
    else if (nFound < 40)
    {    //1d2 Str damage venom (Mild)
        sWhat = "x2_it_poison014";

    }
    else if (nFound < 41)
    {    //1d2 str damage venom (Weak)
        sWhat = "x2_it_poison008";
    }
    else if (nFound < 42)
    {
    int nBookNum = Random(3);
        if (nBookNum = 1)
        {
            //Minor Holy Trap
        sWhat = "nw_it_trap005 ";
