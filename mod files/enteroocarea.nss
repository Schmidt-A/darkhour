void main()
{
    ...
    else if (GetIsPC(oPC))
    {
        ...
        DelayCommand(12.0,FloatingTextStringOnCreature("<cþ  >Remember: You are expected to know and abide by the rules! Make sure to know them well!</c>",oPC,FALSE));
        DelayCommand(18.0,FloatingTextStringOnCreature("<cþ× >Welcome the the new Dark Hour!</c>",oPC,FALSE));
        int nDisease = 0;
