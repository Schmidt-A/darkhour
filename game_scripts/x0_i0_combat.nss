...
string sCombatCondVarname = "X0_COMBAT_CONDITION";

int X0_COMBAT_FLAG_RANGED            = 0x00000001;
int X0_COMBAT_FLAG_DEFENSIVE         = 0x00000002;
int X0_COMBAT_FLAG_COWARDLY          = 0x00000004;
int X0_COMBAT_FLAG_AMBUSHER          = 0x00000008;
...
int SpecialTacticsDefensive(object oTarget)
{
    ...
    int bHasExpertise = GetHasFeat(tempExpertise);
    int bHasImprovedExpertise = GetHasFeat(tempImprovedExpertise);
