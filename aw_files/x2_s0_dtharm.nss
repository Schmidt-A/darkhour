...
if (nRound >= 999)
{
    if(GetLocalInt(OBJECT_SELF, "Carapace") != TRUE)
    {
    effect eShield = EffectDamageShield(10, DAMAGE_BONUS_1d6, DAMAGE_TYPE_DIVINE);
    effect eDur = EffectVisualEffect(463);
    effect eLink = EffectLinkEffects(eShield, eDur);
    SetLocalInt(OBJECT_SELF, "Carapace", TRUE);
    DelayCommand(HoursToSeconds(1), DeleteLocalInt(OBJECT_SELF, "Carapace"));
    FloatingTextStringOnCreature("You may use this ability again in two minutes.", OBJECT_SELF);
