...
if(iRand < 100)
    {
    CreateItemOnObject("mw_bolts", oPC, iRand);
    }else
        {
        CreateItemOnObject("mw_bolts", oPC, 99);
        CreateItemOnObject("mw_bolts", oPC, iRand - 99);
        }
...
if(iRand < 100)
    {
    CreateItemOnObject("cr_bolts", oPC, iRand);
    }else
        {
        CreateItemOnObject("cr_bolts", oPC, 99);
        CreateItemOnObject("cr_bolts", oPC, iRand - 99);
        }
SendMessageToPC(oPC, "You have created " + IntToString(iRand) + " ammunition.");
return;
}
