...
//Updated by DM Vision to include NWN Crafting skills: Craft armor and Craft weapon.
//Here's the formula:
//The chance of creating a standard item was d20+skill >= DC 19
//The new formula is d20+skill+((NWN Craft Armor Skill + NWN Craft Weapon Skill)/2) >= DC 19
//So if the character has 5 ranks in craft weapon and 5 ranks in craft armor, it will
//Look like this: d20+skill+2 >=DC 19. At level 5, with max ranks and skill focus in
//Both Armor and Weapon, the chance is 75%. For Masterworks, the raw skill is added to the chance.
...
CreateItemOnObject("mw_katana", oPC);
return;
}
...
string sFinalAmount = "You currently have " + sAmount + " crafting points.";
SendMessageToPC(oPC, sFinalAmount);
CreateItemOnObject("cr_katana", oPC);
return;
}
