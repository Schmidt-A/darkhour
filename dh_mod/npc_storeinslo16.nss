...
StoreCampaignObject("NPC_STORAGE","16",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","16",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 16 Successfully");
}
