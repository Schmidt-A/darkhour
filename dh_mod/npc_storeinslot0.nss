...
StoreCampaignObject("NPC_STORAGE","10",oNPC);
SetCampaignString("NPC_STORAGE_NAMES","10",GetName(oNPC));
SendMessageToPC(oPC,GetName(oNPC)+" was stored in Slot 10 Successfully");
}
